...
import { worldFood } from "../../data/food/worldFood.js";
import styles from "./FoodQuiz.module.css";
...
export default function FoodQuiz({ lang = "ru" }) {
  const STORAGE_KEY = "global-timeboard-food-progress";
      ...
      >
        <section className={styles.quizCard}>
          <h1 className={styles.title}>
            {lang === "ru"
              ? "Нет вопросов о блюдах"
              : "No food questions yet"}
          </h1>
