...
const STORAGE_KEY = "global-timeboard-marathon-progress";
...
export function MarathonQuiz({ lang = "ru" }) {
  ...
  const [questions, setQuestions] = useState(() => {
    return savedProgress?.questions || shuffleArray(marathonQuizData);
  });
  ...
  function handleRestartQuiz() {
    ...
    setQuestions(shuffleArray(marathonQuizData));
    setQuestionIndex(0);
    setSelectedAnswer(null);
    setScore(0);
  }
